<div id="parceiro" data-role="page" data-theme="b">
	...
	<main>
		...
		<nav data-role="navbar">
			<ul>
				<li><a href="#parceiro" class="ui-btn-active">Projetos Gerenciado</a></li>
				<li><a href="#parceiro-participados">Projetos Participados</a></li>
			</ul>
		</nav>
...
<div id="parceiro-participados" data-role="page" data-theme="b">
	<header data-role="header">
	...
	<main>
		...
		<nav data-role="navbar">
			<ul>
				<li><a href="#parceiro">Projetos Gerenciado</a></li>
				<li><a href="#parceiro-participados" class="ui-btn-active">Projetos Participados</a></li>
			</ul>
		</nav>
		<ul data-role="listview">
		    <li><a href="#">Game 1</a></li>
