<?php
	...
	if ($resultado_id) {
		...
		echo "<form class='ui-filterable'><div class='ui-input-search ui-shadow-inset ui-input-has-clear ui-body-inherit ui-corner-all'><input data-type='search' placeholder='Pesquisar Pessoas'></div></form>";

		while ($registro = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)) {
			echo "<li class='ui-li-has-alt ui-li-has-thumb ui-first-child'>
			<a href='#perfil-membro' class='ui-btn'>";
